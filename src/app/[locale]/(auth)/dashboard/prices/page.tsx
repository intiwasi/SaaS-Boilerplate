      ...
      <div className="relative">
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="mb-16 text-center">
            <h1 className="mb-6 bg-gradient-to-r from-blue-400 via-purple-400 to-indigo-400 bg-clip-text text-4xl font-bold text-transparent md:text-5xl">
              {t('title')}
            </h1>
          ...
          <div className="relative mt-8 grid gap-8 md:grid-cols-2">
            {/* Decorative elements */}
            <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-indigo-500/10 blur-3xl" />
            ...
            <div className="relative">
              ...
              >
                <div className="mb-8">
                  <h3 className="ai-gradient-text mb-4 text-xl font-semibold">Basic AI Analysis</h3>
            ...
            <div className="relative">
              ...
              >
                <div className="mb-8">
                  <h3 className="ai-gradient-text mb-4 text-xl font-semibold">Premium AI Analysis</h3>
